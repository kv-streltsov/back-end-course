...
const blogIdValidation = (0, express_validator_1.body)('blogId').isString().trim().notEmpty().custom((blogId) => __awaiter(void 0, void 0, void 0, function* () {
    const findBlog = yield blogs_scheme_1.blogsModel.findOne({ id: blogId });
    if (!findBlog) {
...
exports.createPostInBlogValidation = [titleValidation, shortDescriptionValidation, contentValidation, input_validation_middleware_1.inputValidationMiddleware];
